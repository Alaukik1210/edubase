        ...
        <div className="w-full h-full  flex flex-col">
          ...
          <div className="h-full bg-gray-100">
            <div className="flex items-center space-x-4 p-4 bg-gray-100 rounded-md w-fit">
              ...
              <div>
                <h2 className="font-semibold text-md">
                  {" "}
                  {user?.user?.fullName ? user.user.fullName : "Marry Doe"}{" "}
                </h2>
            ...
            <div className="p-4">
              ...
              quidem deleniti aperiam sunt minima temporibus minus voluptatibus
              inventore rem provident. Libero eum reiciendis, ex nam laborum
              debitis eligendi ullam sapiente rtgtg.
            </div>
            <div className="bg-gray-100 border-b-2 border-t-2 border-gray-300 border-dashed h-2/3 my-5"></div>
          </div>
        </div>
      </div>
    </div>
